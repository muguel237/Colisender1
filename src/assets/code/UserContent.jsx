  ...
  const renderContent = () => {
    switch (activePage) {
      case "home":
        return (
          <div className="text-center py-5">
            <h1 className="display-3 fw-bold text-dark">Bienvenue sur <span className="text-primary">Colisender</span></h1>
            <p className="fs-4 text-muted">Votre plateforme de logistique collaborative au Cameroun.</p>
          </div>
        );
            ...
            <div className="col-12 col-lg-4">
              <div className="card shadow-sm border-0 rounded-4 d-flex flex-column" style={{ height: "450px" }}>
                ...
                <div className="flex-grow-1 p-3 overflow-auto bg-light">
                  <div className="alert alert-primary mb-2 small">Voyageur: Bonjour, je prends en charge votre colis.</div>
                </div>
      ...
      default:
        return (
          <div className="text-center py-5">
            <h3 className="text-muted">Section {activePage} en cours de développement...</h3>
          </div>
        );
    }
  };
